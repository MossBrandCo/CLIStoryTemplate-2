...
import Foundation
    ...
    func chapterThree(){
        //loop
        let firstSen = ["The next couple days \(String(describing: peopleArray[0].name)) has been watching the other kids walk from school and knows that they will be going out to trick or treat for holloween."]
